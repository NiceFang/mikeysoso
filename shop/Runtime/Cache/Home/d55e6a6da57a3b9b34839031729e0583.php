...
<head>
    ...
    <link rel="stylesheet" href="/Public/home/wap/css/mui.min.css?v=1">
    <link rel="stylesheet" href="/Public/home/wap/css/integralbase.css?v=1">
    <link rel="stylesheet" href="/Public/home/wap/css/feedbackInfo.css?v=1">
    <script src="/Public/home/wap/js/rem.js?v=1"></script>
    <script src="/Public/home/wap/js/jquery1.11.1.min.js?v=1"></script>
    <script src="/Public/home/wap/js/mui.min.js?v=1"></script>
    <script>
    </script>
</head>
...
<body>
    <!-- 头部 -->
    <div class="hear">
        <a href="<?php echo U('User/Personal');?>" class="jiantou"><img src="/Public/home/wap/images/user_jiantouzuo.png" alt=""></a>
        <p><?php echo (L("complins")); ?></p>
        <a href="<?php echo U('User/Complaint');?>" class=" you"><img src="/Public/home/wap/images/bianji.png" alt=""></a>
        <!-- 语言切换 -->
        <!-- 先不要删掉 -->
        <!-- <div class="top"> 
    ...
    <div id="pullrefresh" class="mui-content mui-scroll-wrapper refreshContainer" >
        <div class="mui-scroll">
            <ul class="mui-table-view mui-table-view-chevron uls">
                <!--反馈信息小物件-->
                <?php echo W('Card/jilu',['complaint',2,'0,1,2',1]);?>
            </ul>
        </div>
    </div>
    <!-- 底部 -->
