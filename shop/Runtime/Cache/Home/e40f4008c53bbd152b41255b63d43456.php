<?php if (!defined('THINK_PATH')) exit();?><!-- 支付宝 -->
    ...
    <div class="bank_box alipay_box">
        <div class="top alipay_box_top namex">
            <div class="top_left fl">
                <p class="bank_txt"><?php echo (L("zfb")); ?>：<?php echo ($val["alipay_num"]); ?></p>
                <p class="bank_name"><?php echo (L("ndsjh")); ?>：<?php echo ($val["alipay_phone"]); ?></p>
            </div>
            <div class="top_right fr">
                <img src="<?php echo ($val["alipay_imgs"]); ?>" alt="">
            </div>
        </div>
        <div class="bottom">
            <div class="left fl">
                <?php if(($val["alipay_default"] == 1)): ?><div class="select_bg fl select_bg_box select_red update" data-val="<?php echo ($val["id"]); ?>"></div>
                    <?php else: ?>
                    <div class="select_bg fl select_bg_box update" data-val="<?php echo ($val["id"]); ?>"></div><?php endif; ?>
                <p class="fl"><?php echo (L("mr")); ?></p>
            </div>
            <div class="right fr"  name="alipay_dele" data-val="<?php echo ($val["id"]); ?>">
