...
<body>
    ...
    <!-- <div class="header">
        ...
        <div class="header_c">
            <h2><?php echo (L("sjhm")); ?></h2>
        </div>
        <div class="header_r"></div>
    </div>
    <div class="big_width100">
        <div class="nic_xiu" style="color:#333;">
            <?php echo (L("ndsjh")); ?>：<?php echo ($uname); ?>
        </div>
    </div> -->
    ...
    <div class="user_info">
        <form class="mui-input-group">
            <div class="mui-input-row user_info_lis">
                <label class="name nick bank_select"><?php echo (L("ndsjh")); ?></label>
                <input type="number" class="mui-input-clear nick_input bank_select_input" value="<?php echo ($uname); ?>" disabled="disabled">
            </div>
        </form>
    </div>
</body>
