...
<head>
    ...
    <title><?php echo (L("tjzfbqb")); ?></title>
...
<body>
    ...
    <!--获取绑定支付宝信息小物件-->
    <?php echo W('Card/menu',['alipay']);?>

    <!-- 底部 -->
    <div class="footer"><a href="<?php echo U('User/newAlipayGathering');?>" ><?php echo (L("tjzfbqb")); ?></a></div>
    <div class="Wechat_save" data-name="alipay" style="display:none" ><?php echo (L("bc")); ?></div>
</body>
