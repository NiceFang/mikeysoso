...
<title><?php echo (L("record")); ?></title>
<link rel="stylesheet" href="/Public/home/wap/css/style.css">
<link rel="stylesheet" href="/Public/home/wap/css/Introrecords.css">


<body >
	<!-- 头部 -->
	<div class="header_box">
		<a href="<?php echo U('index/index');?>" class="jiantou"><img src="/Public/home/wap/images/integraimages/jiantouzuo.png" alt=""></a>
		<p class="txt"><?php echo (L("record")); ?></p>
	</div>

	<!-- 列表内容 -->
	<div class="goodslist_box">
		<ul>
			<?php if(is_array($Chan_info)): foreach($Chan_info as $key=>$v): ?><li name="li" data-id="<?php echo ($v["id"]); ?>">

					<div class="head_icon">
						<img src="/Public/home/wap/heads/<?php echo ($v['img_head']); ?>" alt="">
						<div class="userinfo">
							<p class="username"><?php echo ($v["username"]); ?></p>
							<p class="UID">uid:<?php echo ($v["deputy_id"]); ?></p>
						</div>
					</div>

					<div class="money_box">
						<div class="moneyinfo">
							<p class="money"><?php echo ($v["get_nums"]); ?></p>
							<p class="time"><?php echo ($v["get_time"]); ?></p>
...
<!--	<?php if(is_array($$Chan_info)): foreach($$Chan_info as $key=>$v): var_dump($Chan_info)?>
		<div class="annal_ul">
		<div class="annal_ul_l">
				<img src="/Public/home/wap/images/toux-icon.png" alt="">
				<div class="annal_p">
					<p><?php echo M('user')->where(array('userid'=>$v['pay_id']))->getfield('username'); ?></p>
...
<script>
	$(function () {
		$("[name='li']").click(function () {
            ...
            window.location.href="/Index/mutualParticulars.html?ID="+$(this).data('id')+"&test="+test;
        })
    })
</script>
