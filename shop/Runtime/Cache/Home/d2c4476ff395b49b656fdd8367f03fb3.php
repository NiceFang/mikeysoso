...
<body>
    ...
    <div class="buy_hear">
        ...
        <div class="buy_hear_buttom">
            <div class="buy_hear_buttom_left">
                <p class="balance_txt"><?php echo (L("myBalance")); ?></p>
            ...
            <div class="buy_hear_buttom_left">
                <p class="balance_txt"><?php echo (L("myIntegral")); ?></p>
                <div class="balance_box">
                    <div class="balance_box_img fl">
                        <img src="/Public/home/wap/images/balance3030.png" alt="">
                    </div>
    ...
    <!-- 买入金额 -->
    <div class="buy_money">
        <div class="buy_money_top"><?php echo (L("qxzmrje1")); ?></div>
                        ...
                        $.ajax({
                            ...
                            success:function (mes) {
                                if(mes.status == 1){
                                    ...
                                    $(".mm_box li").attr("data","");
                                    i = 0;
                                    setTimeout('window.location.href=\'/Index/myOrderSale.html?type=0\'',1000);
                                }else{
                                    msg_alert(mes.message);
                                    $(".mm_box li").removeClass("mmdd");
                                    $(".mm_box li").attr("data","");
