...
<body>
    ...
    <!-- 买入/卖出 start-->
    <div class="deal_box">
        <a href="<?php echo U('Index/trading_center');?>"><p class="txt"><?php echo (L("sellout")); ?></p></a>
        <a href=""><p class="txt active"><?php echo (L("purchase")); ?></p></a>
    </div>
    <!-- 买入/卖出 end-->
    <!-- 商品列表 start -->
    <div class="goodsList_box">
        <ul  id="orderLists_boxs">
            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><li>
                    ...
                    <div class="sale_box">
                        <a  class="saleBtn" data-id="<?php echo ($vo["id"]); ?>" data-nums="<?php echo ($vo["pay_nums"]); ?>"><?php echo (L("purchase")); ?></a>
                    </div>
    ...
    <div class="creat_index">
        <a href="<?php echo U('Index/buy');?>"><?php echo (L("createorder")); ?></a>
    </div>
...
<script>
    // 实现rem的适屏变化
    document.querySelector('html').style.fontSize = screen.width/7.5 + "px";
...
<script type="text/javascript">
    ...
    $('#orderLists_boxs').on('click','.saleBtn', function(){
        ...
        // console.log(trid);
        //href="<?php echo U('index/myOrderBuy');?>"
        // if(dhnums<100){
        //     msg_alert(dhjebnxy);
        //     return;
        // }
                        ...
                        $.ajax({
                            ...
                            success:function (mes) {
                                ...
                                if(mes.status == 1){
                                    ...
                                    $(".mm_box li").removeClass("mmdd");
                                    $(".mm_box li").attr("data","");
                                    window.location = "<?php echo U('index/myOrderSale');?>"
                                    i = 0;
                                }else{
