...
<title><?php echo (L("notice")); ?></title>
<link rel="stylesheet" href="/Public/home/wap/css/style.css">
<link rel="stylesheet" href="/Public/home/wap/css/meCen.css">


<link rel="stylesheet" href="/Public/home/wap/css/base.css">
<link rel="stylesheet" href="/Public/home/wap/css/news.css">
...
<body>
	...
	<!-- <div class="big_width100">
		<ul class="genggao">
			<?php if(is_array($newinfo)): foreach($newinfo as $key=>$v): ?><li><a href="<?php echo U('User/Newsdetail',array('nid'=>$v['id']));?>">
						<div class="gonggao_l ">
							<h2><strong style="width: 100%;"><?php echo ($v['title']); ?></strong> <span></span></h2>
	...
	<div class="hear">
		<a href="<?php echo U('Index/index');?>"><img src="/Public/home/wap/images/user_jiantouzuo.png" alt=""></a>
		<?php echo (L("notice")); ?>
	</div>

	<div class="cont">
		<ul>
			<?php if(is_array($newinfo)): foreach($newinfo as $key=>$v): ?><li class="list">
				<a href="<?php echo U('User/Newsdetail',array('nid'=>$v['id']));?>">
					<h2><?php echo strip_tags($v['title'])?></h2>
					<!--<h2><?php echo ($v['title']); ?></h2>-->
					<p class="title"><?php echo strip_tags($v['content'])?></p>
					<!--<p class="title"><?php echo ($v['content']); ?></p>-->
					<p class="time ">
						<span class="fl">Mikey钱包</span>
						<span class="fr"><?php echo date("Y-m-d",$v['create_time'])?></span>
					</p>
				</a>
			</li><?php endforeach; endif; ?>
		</ul>
