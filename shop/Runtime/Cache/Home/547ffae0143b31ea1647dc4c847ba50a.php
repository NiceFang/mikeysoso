<?php if (!defined('THINK_PATH')) exit();?><div class="user_info_box">
    <div class="user_info_box_cont">
        <div class="user_info_box_cont_top">
            <div class="div_img fl">
                <!--<img src="/Public/home/wap/images/<?php echo ($userinfos["img_head"]); ?>" alt="">-->
                <img src="/Public/home/wap/heads/<?php echo ($userinfos["img_head"]); ?>" alt="">
            </div>
            <div class="user_info_left fl">
                <p class="name"><?php echo (L("nickname")); ?>:<?php echo ($userinfos['username']); ?></p>
                <p class="uid">UID : <?php echo ($userinfos["userid"]); ?> </p>
                <?php if($userinfos['use_grade'] == 1): ?><p><?php echo (L("rank")); ?>:<?php echo (L("zyz")); ?></p>
                    <?php elseif($userinfos['use_grade'] == 2): ?>
                    <p><?php echo (L("rank")); ?>:<?php echo (L("hbws")); ?></p>
                    <?php elseif($userinfos['use_grade'] == 3): ?>
                    <p><?php echo (L("rank")); ?>:<?php echo (L("hbkw")); ?></p>
                    <?php elseif($userinfos['use_grade'] == 4): ?>
                    <p><?php echo (L("rank")); ?>:<?php echo (L("hbdr")); ?></p>
                    <?php elseif($userinfos['use_grade'] == 5): ?>
                    <p><?php echo (L("rank")); ?>:<?php echo (L("hbds")); ?></p><?php endif; ?>
            </div>
        </div>
        <div class="mony">
            <div class="balance">
                <span><?php echo (L("yue")); ?>:</span>
                <p>
                <img src="/Public/home/wap/images/balance3030.png" alt="">
                <span  class="yue" id="money" ><?php echo ($moneyinfos['cangku_num']); ?></span>
                </p>
            </div>

            <div class="integral">
                <span><?php echo (L("jifen")); ?>:</span>
                <p>
                <img src="/Public/home/wap/images/balance3030.png" alt="">
                <span><?php echo ($moneyinfos['fengmi_num']); ?></span>
                </p>
            </div>
        </div>
    </div>
