...
<head>
    ...
    <!-- 头部 -->
    <div class="hear">
        <a href="<?php echo U('User/accountManage');?>">
            <img src="/Public/home/wap/images/user_jiantouzuo.png" alt="">
        </a>
        <?php echo (L("tjtoken")); ?>
    </div>
    <!--获取绑定imToken信息小物件-->
    <?php echo W('Card/menu',['imtoken']);?>
    <div class="footer">
        <a href="<?php echo U('User/newImrotenGathering');?>"><?php echo (L("tjtoken")); ?> </a>
    </div>
<div class="Wechat_save" data-name="imtoken" style="display:none" ><?php echo (L("bc")); ?></div>
</body>
...
<script>
    $(function () {
        $(".select_bg").on('click',function(){
            $(this).toggleClass("select_red").parent().parent().parent().parent().siblings().children().children().children().children().removeClass('select_red');
        })
    })
