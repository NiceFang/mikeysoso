...
<body>
    <!-- 头部 -->
    <div class="hear">
        <a href="<?php echo U('User/Personal');?>"> <img src="/Public/home/wap/images/user/user_jiantouzuo.png" alt=""></a>
        <?php echo L('zhgl');?>
    </div>
    <!-- 列表选项 -->
    <div class="setlistboxs">
        <ul>
            <li>
                <a href="<?php echo U('Growth/Cardinfos');?>">
            ...
            <li>
                <a href="<?php echo U('User/addAlipayWallet');?>">
                    <div>
            ...
            <li>
                <a href="<?php echo U('User/addWeChatWallet');?>">
                    <div>
            ...
            <li>
                <a href="<?php echo U('User/addImTokenGathering');?>">
                    <div>
                        <img src="/Public/home/wap/images/imtoken.png" alt="">
                        <p>imToken</p>
                    </div>
                    <img src="/Public/home/wap/images/jiantouyou.png" alt="">
                </a>
