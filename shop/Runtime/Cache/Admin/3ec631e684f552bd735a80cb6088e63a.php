            ...
            <div class="panel-body">
                <div class="builder formbuilder-box">
                    ...
                    <div class="builder-container" >
                            <div class="row" >
                                <div class="col-xs-12">
                                    <form action="/admin/User/edit/id/8885.html" method="post" class="form-horizontal form form-builder">
                                        <div class="form-type-list">
                                            ...
                                            <div class="form-group item_title ">
                                                <label class="left control-label">是否降级：</label>
                                                <div class="right">
                                                    <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                        <input type="radio" name="is_degraded"
                                                        <?php if($info['is_degraded'] == 2) echo "checked" ?> value="2">
                                                        <span class="cui-control-indicator"></span>
                                                        <span>是</span>
                                                    </label>
                                                    <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                        <input type="radio" name="is_degraded"
                                                        <?php if($info['is_degraded'] == 1) echo "checked" ?> value="1">
                                                        <span class="cui-control-indicator"></span>
                                                        <span>否</span>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="form-group item_title ">
                                                <label class="left control-label">是否中心账户：</label>
                                                <div class="right">
                                                    <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                        <input type="radio" name="is_center"
                                                        <?php if($info['is_center'] == 1) echo "checked" ?> value="1">
                                                        <span class="cui-control-indicator"></span>
                                                        <span>是</span>
                                                    </label>
                                                    <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                        <input type="radio" name="is_center"
                                                        <?php if($info['is_center'] == 2) echo "checked" ?> value="2">
                                                        <span class="cui-control-indicator"></span>
                                                        <span>否</span>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="form-group item_title ">
                                                <label class="left control-label">韩国是否中心账户：</label>
                                                <div class="right">
                                                    <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                        <input type="radio" name="is_center"
                                                        <?php if($info['is_center'] == 3) echo "checked" ?> value="3">
                                                        <span class="cui-control-indicator"></span>
                                                        <span>是</span>
                                                    </label>
                                                    <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                        <input type="radio" name="is_center"
                                                        <?php if($info['is_center'] == 4) echo "checked" ?> value="4">
                                                        <span class="cui-control-indicator"></span>
                                                        <span>否</span>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="form-group item_title ">
                                                <label class="left control-label">是否团队内交易：</label>
                                                <div class="right">
                                                    <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                        <input type="radio" name="is_states"
                                                        <?php if($info['is_states'] > 0) echo "checked" ?> value="1">
                                                        <span class="cui-control-indicator"></span>
                                                        <span>是</span>
                                                    </label>
                                                    <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                        <input type="radio" name="is_states"
                                                        <?php if($info['is_states'] == 0) echo "checked" ?> value="0">
                                                        <span class="cui-control-indicator"></span>
                                                        <span>否</span>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="form-group item_title ">
                                                <label class="left control-label">是否自动收款：</label>
                                                <div class="right">
                                                    <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                        <input type="radio" name="is_auto"
                                                        <?php if($info['is_auto'] == 1) echo "checked" ?> value="1">
                                                        <span class="cui-control-indicator"></span>
                                                        <span>是</span>
                                                    </label>
                                                    <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                        <input type="radio" name="is_auto"
                                                        <?php if($info['is_auto'] == 0) echo "checked" ?> value="0">
                                                        <span class="cui-control-indicator"></span>
                                                        <span>否</span>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="form-group item_title ">
                                                <label class="left control-label">是否成为推荐人：</label>
                                                <div class="right">
                                                    <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                        <input type="radio" name="recommend"
                                                        <?php if($info['recommend'] == 1) echo "checked" ?> value="1">
                                                        <span class="cui-control-indicator"></span>
                                                        <span>是</span>
                                                    </label>
                                                    <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                        <input type="radio" name="recommend"
                                                        <?php if($info['recommend'] == 0) echo "checked" ?> value="0">
                                                        <span class="cui-control-indicator"></span>
                                                        <span>否</span>
                                                    </label>
                                                </div>
                                            ...
                                            <div class="form-group item_title ">
                                             ...
                                             <!--   <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                    <input type="checkbox" name="quanxian[]"
                                                    <?php if(in_array(5, $quanxian)) echo "checked" ?> value="5">
                                                    <span class="cui-control-indicator"></span>
                                                    <span>商城买入</span>
                                                </label>-->
                                                </div>
                                            ...
                                            <div class="form-group item_title ">
                                                <label class="left control-label">禁止会员团队：</label>
                                                <div class="auth3" style="line-height:120%;" >

                                                    <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                        <input type="checkbox" name="team[]"
                                                        <?php if(in_array(1, $team)) echo "checked" ?> value="1">
                                                        <span class="cui-control-indicator"></span>
                                                        <span>转入</span>
                                                    </label>
                                                    ...
                                                    <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                        <input type="checkbox" name="team[]"
                                                        <?php if(in_array(2, $team)) echo "checked" ?> value="2">
                                                        <span class="cui-control-indicator"></span>
                                                        <span>转出</span>
                                                    </label>
                                                    ...
                                                    <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                        <input type="checkbox" name="team[]"
                                                        <?php if(in_array(3, $team)) echo "checked" ?> value="3">
                                                        <span class="cui-control-indicator"></span>
                                                        <span>买入</span>
                                                    </label>
                                                    ...
                                                    <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
                                                        <input type="checkbox" name="team[]"
                                                        <?php if(in_array(4, $team)) echo "checked" ?> value="4">
                                                        <span class="cui-control-indicator"></span>
                                                        <span>卖出</span>
                                                    </label>
                                                    <!--   <label class="checkbox-inline" style="margin-top: 10px;margin-left: 0px;">
