                        ...
                        <div class="tab-content" >
                            ...
                            <div id="tab1" class="tab-pane active" >
                                <div class="col-xs-12">
                                        ...
                                        <form action="/admin/User/AddFruits/id/8885.html" method="post" class="form-horizontal form form-builder form1">
                                        <div class="form-type-list">
                                           ...
                                           <div class="form-group item_title ">
                                            ...
                                            <div class="form-group item_title ">
                                             ...
                                             <div class="form-group item_title ">
                                                <label class="left control-label"><?php echo (L("yue")); ?>：</label>
                                                <div class="right">
                                            ...
                                            <div class="form-group item_title ">
                                                <label class="left control-label"><?php echo (L("jifen")); ?>：</label>
                                                <div class="right">
                                            ...
                                            <div class="form-group item_pid ">
                                                ...
                                                <div class="right">
                                                    <select name="opetype" class="form-control cui-select select">
                                                        ...
                                                        <option value="1" selected=""><?php echo (L("yue")); ?></option>
                                                        <option value="2"><?php echo (L("jifen")); ?></option>
                                                    </select>
                                                </div>
                                            </div>
                            ...
                            <!-- 卡片2 -->
                             <div id="tab2" class="tab-pane" >
                                    <div class="col-xs-12">
                                        ...
                                        <div style="height:20px;" ></div>
                                        <form action="/admin/User/AddFruits/id/8885.html" method="post" class="form-horizontal form form-builder form2">
                                        <div class="form-type-list">
                                            <div class="form-group hidden item_id ">
                                                <label class="left control-label">ID：</label>
                                                <div class="right">
