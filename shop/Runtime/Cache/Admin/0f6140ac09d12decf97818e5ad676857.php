                    ...
                    <div class="builder-toolbar">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 clearfix">
                                ...
                                <form class="form" method="get" style="position: relative;" action="<?php echo U('/Admin/Award/index');?>">
                                        ...
                                        <table class="table table-bordered table-striped table-hover">
                                            ...
                                            <tbody>
                                                <?php if(is_array($data_list)): foreach($data_list as $key=>$v): ?><tr>
                                                        <td><?php echo ($v["idid"]); ?></td>
                                                        <td><?php echo ($v["id"]); ?></td>
                                                        <td><?php echo ($v["time"]); ?></td>
                                                        <td><?php echo ($v["explain"]); ?></td>
                                                        <td><?php echo ($v["treasure"]); ?></td>
                                                        <td><?php echo ($v["changeInfo"]); ?></td>
...
//             "&date_end="+date_end+"&keyword="+keyword+"&querytype="+querytype);
           ...
           window.location.href="<?php echo U('/admin/Award/index');?>?isLead=1&date_start="+date_start +
                   "&date_end="+date_end+"&keyword="+keyword+"&querytype="+querytype;
