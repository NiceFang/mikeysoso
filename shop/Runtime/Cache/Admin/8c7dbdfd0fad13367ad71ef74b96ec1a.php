                ...
                <div class="builder formbuilder-box">
                    <div class="builder-tabs builder-form-tabs">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <a href="<?php echo U('Complaint/index');?>">未读</a>
                            </li>
                            <li <?php if(($type) == "over"): ?>class="active"<?php endif; ?> >
                                <a href="<?php echo U('Complaint/index',array('type'=>'over'));?>">已读</a>
                            </li>
                            <li <?php if(($type) == "reply"): ?>class="active"<?php endif; ?> >
                                  <a href="<?php echo U('Complaint/index',array('type'=>'reply'));?>">已回复</a>
                            </li>
                                        ...
                                        <div class="panel panel-default table-responsive">
                                            <table class="table table-bordered table-striped table-hover">
                                              <thead>
                                                ...
                                                <tbody>
                                                    <?php
 $status_name[0]='未读'; $status_name[1]='已读'; $status_name[2]='已回复'; ?>
                                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                                                            ...
                                                            <td>
                                                                <?php if(($data['status'] == 0) OR ($data['status'] == 1)): ?><a name="edit" title="查看详情" class="label label-primary-outline label-pill" href="<?php echo U('edit',array('id'=>$data['id']));?>">详情</a>
                                                                ...
                                                                <a name="reply" title="回复" class="label label-primary-outline label-pill" href="<?php echo U('reply',array('id'=>$data['id']));?>">回复</a>
                                                                <?php else: ?>
                                                                <a name="edit" title="查看详情" class="label label-primary-outline label-pill" href="<?php echo U('edit',array('id'=>$data['id']));?>">详情</a>
                                                                <a name="delete" title="删除" class="label label-danger-outline label-pill ajax-get confirm"  href="<?php echo U('delete',array('id'=>$data['id']));?>">删除</a>
                                                                <a name="reply" title="查看" class="label label-primary-outline label-pill" href="<?php echo U('reply',array('id'=>$data['id']));?>">查看</a><?php endif; ?>
                                                            </td>
