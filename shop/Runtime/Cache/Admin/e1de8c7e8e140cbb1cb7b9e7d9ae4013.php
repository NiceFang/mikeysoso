                                ...
                                <div class="col-xs-12">
                                    <div class="builder-table">
                                        ...
                                        <!-- 树 -->
                                          <div class="tree">
                                              <ul>
                                                  <?php if(is_array($tree)): foreach($tree as $key=>$vo): ?><li style="display:none" name="li">
                                                      <span name="span" data-userid="<?php echo ($vo["userid"]); ?>">
                                                          <?php if($vo["counts"] == 0): ?><i class="icon-plus-sign fa-user  blue "></i>  <?php echo ($vo["username"]); ?>
                                                              <?php else: ?>
                                                              <i class="icon-plus-sign fa-sitemap  blue "></i>  <?php echo ($vo["username"]); endif; ?>
                                                      </span>
                                                      <a href="#"><?php echo ($vo["account"]); ?></a>
                                                  </li><?php endforeach; endif; ?>
                                              </ul>
