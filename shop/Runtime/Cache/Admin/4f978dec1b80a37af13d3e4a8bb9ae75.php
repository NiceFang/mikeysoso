                    ...
                    <div class="builder-container" >
                        <div class="row" >
                            <div class="col-xs-12" >
                                <form action="<?php echo U('Config/groupSave');?>" method="post" class="form-horizontal form form-builder" style="margin-bottom:20px">
                                    <div class="form-type-list">
                                        ...
                                        <div class="form-group item_config[WEB_SITE_TITLE] ">
                                            <label class="left control-label" style="width: 120px;">积分基础加速：</label>
                                ...
                                直推奖设置<hr style="margin-top: 0px;width: 100%">


                                <form action="<?php echo U('Config/zhitui_Save');?>" method="post" class="form-horizontal form form-builder form-builderg" style="margin-bottom:20px">
                                    <div class="form-type-list">
                                        ...
                                        <div class="form-group item_config[WEB_SITE_TITLE] ">
                                            ...
                                            <div style="width:100%" class="input-group">
                                                ...
                                                <label class="left" style="width:80px">直推加速：</label>

                                                <input type="text" name="zhitui" class="left" value="<?php echo ($manage["zhitui"]); ?>" >
                                ...
                                区块奖设置<hr style="margin-top: 0px;width: 100%">


                                <form action="<?php echo U('Config/qukuai_Save');?>" method="post" class="form-horizontal form form-builder form form-builderq" style="padding-left:0;margin-bottom:20px">
                                    <div class="form-type-list">
                                        <div class="form-group item_config[WEB_SITE_TITLE] " style="margin-left: 0;">
                                            <div style="width:100%" class="input-group">
                                                <label class="left"  style="width:190px" >(拿1代)          奖励加速：</label>
                                                <input type="text" name="qukuaij_1" class="left" value="<?php echo ($qukuai["qukuaij1"]); ?>" >
                                                <span class="input-group-addon left" style="margin-left:0px;width:30px">%</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group item_config[WEB_SITE_TITLE] " style="margin-left: 0;">
                                            <div style="width:100%" class="input-group">
                                                <label class="left"  style="width:190px" >(拿2到15代)          所需直推人数：</label>
                                                <input type="text" name="qukuai_2" style="width:118px"  class="left" value="<?php echo ($qukuai[1]["tip"]); ?>" >

                                                <label class="left" style="margin-left:30px;width:80px">奖励加速：</label>
                                                <input type="text" name="qukuaij_2" class="left" value="<?php echo ($qukuai["qukuaij2"]); ?>" >
                                                <span class="input-group-addon left" style="margin-left:0px;width:30px">%</span>
                                            </div>
                                        </div>
                                        <div class="form-group"></div>
                                        <div class="form-group bottom_button_list" style="margin-left: 0;">
                                            <a class="btn btn-primary submit ajax-post" type="submit" target-form="form-builderq">保存</a>
                                            <a class="btn btn-danger return" onclick="javascript:history.back(-1);return false;">取消</a>
                                        </div>
                                    </div>
                                </form>
                                VIP奖设置<hr style="margin-top: 0px;width: 100%">
                                        ...
                                        <form action="<?php echo U('Config/vip_Save');?>" method="post" class="form-horizontal form form-builder form-builderv" style="margin-bottom:20px">
                                            <div class="form-type-list">
                                                <div class="form-group item_config[WEB_SITE_TITLE] " style="margin-left: 0;">
                                                    <div style="width:100%" class="input-group">
                                                        <label class="left"  style="width:190px" >(环保卫士)         所需积分：</label>
                                                        <input type="text" name="vipji_1" style="width:118px"  class="left" value="<?php echo ($vip[0]["tip"]); ?>" >

                                                        <!--<label class="left" style="margin-left:30px;width:80px">奖励加速：</label>-->
                                                        <!--<input type="text" name="vipj_1" class="left" value="<?php echo ($vip["vipj1"]); ?>" >-->
                                                        <!--<span class="input-group-addon left" style="margin-left:0px;width:30px">%</span>-->
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group item_config[WEB_SITE_TITLE] " style="margin-left: 0;">
                                                    <div style="width:100%" class="input-group">
                                                        <label class="left"  style="width:190px" >(环保顾问) 所需积分：</label>
                                                        <input type="text" name="vipji_2" style="width:118px"  class="left" value="<?php echo ($vip[1]["tip"]); ?>" >

                                                        <!--<label class="left" style="margin-left:30px;width:80px">奖励加速：</label>-->
                                                        <!--<input type="text" name="vipj_2" class="left" value="<?php echo ($vip["vipj2"]); ?>" >-->
                                                        <!--<span class="input-group-addon left" style="margin-left:0px;width:30px">%</span>-->

                                                        <label class="left"  style="width:190px;margin-left: 30px;" >所需直推环保卫士数：</label>
                                                        <input type="text" name="vip_2" style="width:138px"  class="left" value="<?php echo ($vip[1]["options"]); ?>" >
                                                ...
                                                <div class="form-group item_config[WEB_SITE_TITLE] " style="margin-left: 0;">
                                                    <div style="width:100%" class="input-group">
                                                        <label class="left"  style="width:190px" >(拿15代环保达人)         所需积分：</label>
                                                        <input type="text" name="vipji_3" style="width:118px"  class="left" value="<?php echo ($vip[2]["tip"]); ?>" >

                                                        <label class="left" style="margin-left:30px;width:80px">积分增加：</label>
                                                        <input type="text" name="vipj_3" class="left" value="<?php echo ($vip["vipj3"]); ?>" >
                                                        <span class="input-group-addon left" style="margin-left:0px;width:30px">%</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group item_config[WEB_SITE_TITLE] " style="margin-left: 0;">
                                                    <div style="width:100%" class="input-group">
                                                        <label class="left"  style="width:190px" >(拿无限环保大使)    所需积分：</label>
                                                        <input type="text" name="vipji_4" style="width:118px"  class="left" value="<?php echo ($vip[3]["tip"]); ?>" >

                                                        <label class="left"  style="width:190px;margin-left: 30px;" >所需直推环保达人数：</label>
                                                        <input type="text" name="vip_4" style="width:138px"  class="left" value="<?php echo ($vip[3]["options"]); ?>" >
                                                        <label class="left" style="margin-left:30px;width:80px">，</label>
                                                        <label class="left" style="margin-left:30px;width:80px">积分增加：</label>
                                                        <input type="text" name="vipj_4" class="left" value="<?php echo ($vip["vipj4"]); ?>" >
                                                        <span class="input-group-addon left" style="margin-left:0px;width:30px">%</span>
                                        ...
                                        流通奖设置<hr style="margin-top: 0px;width: 100%">


                                        <form action="<?php echo U('Config/fenx_Save');?>" method="post" class="form-horizontal form form-builder form-builderf" style="padding-left: 0;margin-bottom:20px">
                                            <div class="form-type-list">
                                                <div class="form-group item_config[WEB_SITE_TITLE] " style="margin-left: 0;">
                                                    <div style="width:100%" class="input-group">
                                                        <label class="left"  style="width:90px" >积分达到：</label>
                                                        <input type="text" name="fenxji_1" style="width:220px"  class="left" value="<?php echo ($fenx[0]["tip"]); ?>" >

                                                        <label class="left" style="margin-left:30px;width:190px">所需直推环保卫士人数：</label>
                                                        <input type="text" name="fenx_1" class="left" value="<?php echo ($fenx[0]["options"]); ?>" style="width:134px;">
                                                        <label class="left" style="margin-left:30px;width:80px">，</label>
                                                        <label class="left" style="margin-left:30px;width:120px">流通加速：</label>
                                                        <input type="text" name="fenxj_1" class="left" value="<?php echo ($fenx["zhuandj1"]); ?>" style="width:160px;">
                                                        <span class="input-group-addon left" style="margin-left:0px;width:30px">%</span>
                                                    </div>
                                                </div>
                                                <div class="form-group"></div>
